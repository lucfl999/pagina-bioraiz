...
import { useReveal, Counter, SectionHead, Placeholder, LeafShape, CircleShape, ExpositorCard } from '../components/shared.jsx';
import { EXPOSITORES, ACTIVIDADES, NUMEROS } from '../data.js';
      ...
      <div className="container bz-agenda-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 80, alignItems: "start" }}>
        <div className="reveal">
          ...
          <p style={{ fontSize: 16, color: "var(--bz-texto-secundario)", lineHeight: 1.7, marginBottom: 32 }}>
            Charlas, talleres, música en vivo, espacios para chicos y una cocina abierta que no para. El programa es denso pero con respiros.
          </p>
...
function NewsletterBlock() {
  ...
  const { LeafShape: Leaf } = { LeafShape };
        ...
        <div className="reveal" style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ fontSize: 16, color: "var(--bz-texto-secundario)", marginBottom: 32, maxWidth: 480, margin: "0 auto 32px" }}>
              Novedades del evento, historias de productores y notas eco. Sin spam, sin urgencia.
            </p>

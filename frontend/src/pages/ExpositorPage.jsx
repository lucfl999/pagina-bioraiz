...
import { useReveal, ExpositorCard, LeafShape, SubPageHeader } from '../components/shared.jsx';
import { EXPOSITORES, CATEGORIES } from '../data.js';
      ...
      <section style={{ padding: "80px 0 120px", background: "var(--bz-fondo-alt)" }}>
        <div className="container-narrow">
          <div className="reveal bz-postular" style={{
            ...
            <button className="btn btn-primary" style={{ position: "relative", zIndex: 1 }} onClick={() => setPage("participa")}>Quiero postularme</button>
          </div>
        </div>
        <style>{`

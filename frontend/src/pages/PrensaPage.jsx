...
import { useReveal, SectionHead, SubPageHeader, LeafShape } from '../components/shared.jsx';
import { PRENSA_NOTAS } from '../data.js';

export default function PrensaPage({ setPage }) {
  useReveal();
  const [copied, setCopied] = useState(false);

  const copyEmail = () => {
    navigator.clipboard?.writeText("prensa@bioraiz.net");
    setCopied(true);
  ...
  return (
    <div className="page-enter">
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 56, alignItems: "start" }} className="bz-prensa-top">
              ...
              <div style={{ display: "grid", gap: 12 }}>
                {[
                  ...
                  <a key={i} href="#" className="reveal" style={{
                    ...
                    background: "var(--bz-beige-hueso)", border: "0.5px solid var(--bz-borde-ligero)",
                    borderRadius: "var(--bz-radius-md)", transition: "all 250ms var(--bz-ease)",
            ...
            <div className="reveal" style={{ position: "sticky", top: 120 }}>
              <div style={{ background: "var(--bz-verde-profundo)", color: "var(--bz-beige-hueso)", borderRadius: "var(--bz-radius-xl)", padding: "36px 32px", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <button onClick={copyEmail} style={{
                    width: "100%", padding: "14px 18px", background: "rgba(250, 246, 237, 0.08)",
                    border: "0.5px solid rgba(230, 203, 122, 0.4)", borderRadius: "var(--bz-radius-md)",
                    fontSize: 13, color: "var(--bz-beige-hueso)", textAlign: "left",
                    display: "flex", justifyContent: "space-between", alignItems: "center",
                    fontFamily: "var(--bz-font-mono)", marginBottom: 8, transition: "all 200ms var(--bz-ease)",
                  }}>
                    prensa@bioraiz.net
                  ...
                  <a href="https://wa.me/5492995781006" style={{
                    display: "flex", alignItems: "center", justifyContent: "space-between",
                    padding: "14px 18px", background: "rgba(250, 246, 237, 0.08)",
                    border: "0.5px solid rgba(230, 203, 122, 0.4)", borderRadius: "var(--bz-radius-md)",
                    fontSize: 13, color: "var(--bz-beige-hueso)", fontFamily: "var(--bz-font-mono)",
                  }}>
                    +54 9 299 578 1006
      ...
      <section style={{ padding: "100px 0", background: "var(--bz-fondo-alt)" }}>
        <div className="container">
          <SectionHead
            ...
            sub="Una muestra de cómo otros medios contaron BIORAIZ."
          />
          <div style={{ marginTop: 56, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 16 }}>
            {PRENSA_NOTAS.map((nota, i) => (
              <a key={i} href={nota.url} className="reveal" style={{
                background: "var(--bz-beige-hueso)", padding: "28px", borderRadius: "var(--bz-radius-lg)",
                border: "0.5px solid var(--bz-borde-ligero)", display: "flex", flexDirection: "column", gap: 14,
                transition: "all 250ms var(--bz-ease)", transitionDelay: `${(i % 3) * 60}ms`,
              }}
      ...
      <section style={{ padding: "100px 0", background: "var(--bz-fondo-base)" }} className="trama">
        <div className="container">
          <SectionHead eyebrow="Datos rápidos" title={<>Para citar <em>en tu nota.</em></>} />
